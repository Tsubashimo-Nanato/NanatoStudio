## 4. Hardware Platform\* (\* means may be read selectively)
...
- [Vehicle Document](../assets/aiformula/documents/01_機体ドキュメント.pdf)
- [Board Details](../assets/aiformula/documents/02_基板詳細.pdf)
- [Motor Controller Guide](../assets/aiformula/documents/03_モータコントローラ.pdf)
- [CAN Commands for Ubuntu](../assets/aiformula/documents/04_CANのコマンド(Ubuntu).pdf)
- [Parts List](../assets/aiformula/documents/AIFormula部品表.pdf)
- [CAN ID Allocation Sheet](../assets/aiformula/documents/AIF_CAN-ID割り当て.xlsx)
- [RoboteQ CAN Manual](../assets/aiformula/documents/RoboteQ_CANマニュアル.pdf)
